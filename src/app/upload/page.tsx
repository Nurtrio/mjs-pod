      ...
      <main style={{ flex: 1, padding: '32px 40px 48px', maxWidth: 960, margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 28 }}>
          <div>
            ...
            <p style={{ fontSize: 15, color: 'var(--muted)', marginTop: 6, margin: 0, marginBlockStart: 6 }}>
              Add PDF invoices, then assign to driver routes
            </p>
          </div>
        ...
        {allDone && (
          ...
          >
            ...
            <span style={{ flex: 1 }}>All invoices uploaded</span>
            <a
              href="/routes"
              style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {!allUploaded && (
              <button
                ...
                disabled={uploading || anyExtracting}
                style={{
                  width: '100%', height: 58,
                  background: (uploading || anyExtracting)
                    ? 'linear-gradient(135deg, rgba(52,199,89,0.5), rgba(40,167,69,0.5))'
                    : 'linear-gradient(135deg, #34c759, #28a745)',
                  color: '#fff', border: 'none', borderRadius: 16,
                  fontSize: 17, fontWeight: 600, cursor: (uploading || anyExtracting) ? 'default' : 'pointer',
                  fontFamily: 'inherit',
                  boxShadow: (uploading || anyExtracting) ? 'none' : '0 4px 16px rgba(52,199,89,0.25)',
                  transition: 'all 0.2s ease',
